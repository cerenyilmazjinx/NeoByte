...
#[derive(Debug)]
pub struct NeoByteProcessor {
    verbose: bool,
    processed_count: usize,
}

impl NeoByteProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting NeoByte processing");
    
    let mut processor = NeoByteProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = NeoByteProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = NeoByteProcessor::new(false);
